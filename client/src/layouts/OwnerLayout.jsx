...
//     if (email) {
//       axios
//         .get(`http://localhost:5000/api/owner/${email}`)
//         .then((res) => {
//           if (res.data.Photo) {
...
//         {/* Owner Photo (same design as Admin) */}
//         <div className="profile-photo-container">
//           {sidebarLoading ? (
//             <div className="profile-photo placeholder"></div>
//           ) : (
//             <img src={photoUrl || DEFAULT_AVATAR} alt="Owner" className="profile-photo" />
//           )}
//         </div>

//         <ul className="menu">
//           <li><Link to="/ownerdashboard">🏠 Dashboard</Link></li>
//           <li><Link to="/owner/announcement">📢 Announcements</Link></li>
//           <li><Link to="/owner/active-maintenance">💳 Pay Maintenance</Link></li>
//           <li><Link to="/owner/SubmitComplaint">📝 Complaints</Link></li>
//           <li><Link to="/owner/hall-booking">🎉 Hall Booking</Link></li>
//           <li><Link to="/owner/appointments">🏘 Rental Appointments</Link></li>
//           {/* <li><Link to="/owner/tenants">👤 Tenant Registration</Link></li> */}
...
//             <Link to="/owner/OwnerProfile" className="nav-link">👤 Profile</Link> |
//             <Link to="/owner/change-password" className="nav-link">🔐 Change Password</Link>
//           </div>
//         </header>
...
//       {/* STYLES (Copied Same from AdminLayout) */}
//       <style>{`
