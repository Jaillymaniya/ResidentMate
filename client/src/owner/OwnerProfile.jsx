...
//       try {
//         // Replace with your actual backend route for owner profile
//         const res = await axios.get(`http://localhost:5000/api/owner/${ownerEmail}`);
//         setOwner(res.data);
//         if (res.data.Photo) {
...
//       // Replace endpoint here too
//       await axios.put(`http://localhost:5000/api/owner/update/${ownerEmail}`, formData, {
...
export default function OwnerProfile() {
    ...
    const fetchOwner = async () => {
      try {
        const res = await axios.get(
          `http://localhost:5000/api/owner/${ownerEmail}`
        );
        setOwner(res.data);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(
        `http://localhost:5000/api/owner/update/${ownerEmail}`,
        formData,
        {
          headers: { "Content-Type": "multipart/form-data" },
        }
